...
let ChatGateway = class ChatGateway {
    ...
    handleJoinRoom(client, sessionId) {
        client.join(sessionId);
        console.log(`Client ${client.id} joined room ${sessionId}`);
    }
    async handleSendMessage(client, payload) {
        const savedMessage = await this.chatService.saveMessage(payload.sessionId, payload.sender, payload.message, payload.type, payload.customerName, payload.customerEmail);
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ChatGateway.prototype, "handleJoinAdmin", null);
